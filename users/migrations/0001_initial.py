    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_id', models.IntegerField(blank=True, null=True, verbose_name='ID в Телеграмме')),
                ('phone', models.CharField(blank=True, help_text='Введите номер телефона', max_length=35, null=True, verbose_name='Телефон')),
                ('city', models.CharField(blank=True, help_text='Введите город проживания', max_length=100, null=True, verbose_name='Город')),
